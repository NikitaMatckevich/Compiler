...
: file_{move(file)}, fin_{}, lines_{}, sv_{}, line_nb_{0}, curr_{} {
...
void Lexer::NextToken() {
  ...
  if (numbers_.find(c) != std::string::npos) {
    ...
    switch (c) {
      case '+' : curr_ = Token(file_, sv_, line_nb_, types::Add  {}); break;
      case '-' : curr_ = Token(file_, sv_, line_nb_, types::Sub  {}); break;
      case '*' : curr_ = Token(file_, sv_, line_nb_, types::Mul  {}); break;
      case '/' : curr_ = Token(file_, sv_, line_nb_, types::Div  {}); break;
      case '(' : curr_ = Token(file_, sv_, line_nb_, types::LPar{}); break;
      case ')' : curr_ = Token(file_, sv_, line_nb_, types::RPar{}); break;
      case ';' : curr_ = Token(file_, sv_, line_nb_, types::Eol  {}); break;
      default  : throw
        LexerError(file_, sv_, line_nb_);
    }
  }
